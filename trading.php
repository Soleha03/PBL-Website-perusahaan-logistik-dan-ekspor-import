...
<section id="industry" style="padding: 60px 0; margin-top: 80px;">
  <div class="container">
    <div class="section-header text-center wow fadeInUp" style="margin-bottom: 40px;">
      ...
      <p class="section-description">We specialize in the trading of high-quality palm oil sourced from reputable plantations. Our extensive network allows us to offer a wide range of palm oil products, catering to various industries such as food and beverage, cosmetics, and biofuels.</p>
    </div>

    <div class="row">
      <?php
        require('admin/koneksi.php');
        $sql = "SELECT * FROM trading ORDER BY created_at DESC LIMIT 6";
