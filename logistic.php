...
<section id="industry" style="padding: 60px 0; margin-top: 80px;">
  <div class="container">
    <div class="section-header text-center wow fadeInUp" style="margin-bottom: 40px;">
      <h3 class="section-title">Logistic and Shipping</h3>
      <p class="section-description">With our integrated logistic services, we strive to be your top logistics partner.

offering a one-stop solution to meet all your logistic needs.</p>
    </div>

    <div class="row">
      <?php
        require('admin/koneksi.php');
        $sql = "SELECT * FROM logistic ORDER BY created_at DESC LIMIT 6";
